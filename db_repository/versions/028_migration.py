...
athlete = Table('athlete', post_meta,
    ...
    Column('ice_email', String(length=64)),
    Column('disability', String(length=64)),
    Column('pace', String(length=64)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['athlete'].columns['ice_email'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['athlete'].columns['ice_email'].drop()
