...
athlete = Table('athlete', post_meta,
    ...
    Column('name_nick', String(length=64)),
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['athlete'].columns['nickname'].drop()
    post_meta.tables['athlete'].columns['name_nick'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['athlete'].columns['nickname'].create()
    post_meta.tables['athlete'].columns['name_nick'].drop()
